...
//   },[inputRef.current?.value.length])
  ...
  return (
    <div className="w-full h-screen bg-bg_primary  p-8 relative flex flex-col  gap-[1.5rem] ">
      <div className="heading font-mona_bold tab:text-7xl bg-gradient-to-r from-indigo-700 via-purple-300 to-pink-400 bg-clip-text text-transparent mobile:text-4xl mobile:leading-[3rem] w-full flex justify-center items-center  py-2">
        How did your day go?
      </div>
      <div className="h-[85vh] z-[100] w-[95%] overflow-scroll flex flex-col justify-start items-start gap-[2rem] overflow-x-hidden no-scrollbar " ref={sectionRef}>
      {

      }
      </div>
      <div className="flex justify-start w-full relative items-center z-20" >
