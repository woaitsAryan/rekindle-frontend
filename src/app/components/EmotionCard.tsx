...
const EmotionCard = (props: EmotionCardProps) => {
  return (
    <div className="bg-[rgba(255,250,250,0.1)] cursor-pointer flex flex-col gap-[.5rem] rounded-[1rem] px-[1.5rem] py-[1.5rem] w-full z-[1000] justify-around text-white border-[1px] border-[#aeaeae60]" onClick={()=>{
